...
# peak finding parameters for final peak filtering of feature map
...
particleCoords = peak_local_max(mapFinal,min_distance=minDistance,threshold_rel=relThreshold)
...
for element in particleCoords:
    evalImage[ element[0], element[1] ] = 0    # red
for element in pickedCoords:
    evalImage[ element[1], element[0] ] = 4    # white
